<h1 className="text-[#FFFFFF]  text-lg pb-3 font-Gilroy">
        ...
        <div className="flex flex-row gap-10">
          ...
          <div className="flex flex-row gap-3 pt-3">
            ...
            <div className="flex flex-col gap-3">
              <span className="font-Gilroy-Regular text-[14px] font-normal text-[#FFEEE6]">
                :&emsp;An engaging and interactive session where innovators,
                entrepreneurs, and thinkers come together over a cup of chai to
                pitch their one-liner ideas, spark discussions, and gain
